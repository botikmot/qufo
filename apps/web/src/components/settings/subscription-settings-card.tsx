  ...
  return (
    <div className="space-y-4">
        ...
        <div className="space-y-6 p-6">
          <div className="qufo-surface-soft rounded-2xl p-5">
            ...
            {isDealifyLifetime && billing.quotationUsage && (
              <div className="rounded-2xl border mb-4 border-emerald-400/10 bg-emerald-400/[0.03] p-5">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="rounded-xl border border-emerald-400/10 bg-emerald-400/[0.08] px-3 py-2 text-right">
                ...
                {billing.quotationUsage.remaining === 0 && (
                  <div className="mt-4 rounded-xl border border-amber-400/10 bg-amber-400/[0.04] px-3 py-2 text-xs text-amber-300">
          ...
          {lifetime ? (
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <DateCard label="Trial ends" value={subscription.trialEndsAt} />
            </div>
          ) : active ? (
            <>
              <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="rounded-xl border border-[var(--qufo-border)] bg-white/[0.015] px-4 py-3">
                <p className="text-xs text-slate-600">
                  Original trial:{" "}
                  {formatSubscriptionDate(subscription.trialStartedAt)} –{" "}
      ...
      <div className="qufo-surface overflow-hidden rounded-3xl">
        <div className="border-b border-[var(--qufo-border)] px-6 py-5">
          <div>
            <h2 className="font-medium text-white">Billing History</h2>
    ...
    <div className="flex flex-col gap-4 px-6 py-4 sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="sm:text-right">
        {payment.periodStart && payment.periodEnd ? (
          <>
            <div className="text-xs text-slate-400">Subscription period</div>
