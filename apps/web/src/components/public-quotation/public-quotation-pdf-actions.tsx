...
import { QuotationPdfDocument } from "../quotations/pdf/quotation-pdf-document";

import { mapPublicQuotationToPdfData } from "./map-public-quotation-to-pdf-data";
...
type PublicQuotationPdfActionsProps = {
  quotation: PublicQuotation;
};

export function PublicQuotationPdfActions({
  quotation,
}: PublicQuotationPdfActionsProps) {
  ...
  async function createPdfBlob() {
    const data = mapPublicQuotationToPdfData(quotation);
  ...
  async function handlePreview() {
    try {
      ...
      console.error("Unable to preview public quotation PDF.", error);
    } finally {
      setGenerating(false);
    }
  }
