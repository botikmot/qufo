...
type QuotationsToolbarProps = {
  ...
  onStatusChange: (status: QuotationStatusFilter) => void;
};
...
export function QuotationsToolbar({
  ...
  return (
    <div className="flex flex-col gap-4 rounded-2xl p-4 lg:flex-row lg:items-center lg:justify-between">
      ...
      <Select
        value={status}
        onValueChange={(value) =>
          onStatusChange(value as QuotationStatusFilter)
        }
      >
        ...
        <SelectContent>
          ...
          {QUOTATION_STATUS_OPTIONS.map((quotationStatus) => (
            <SelectItem key={quotationStatus} value={quotationStatus}>
